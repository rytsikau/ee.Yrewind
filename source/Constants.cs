...
namespace yrewind
{
    ...
    static class Constants
    {
        ...
        public static readonly Dictionary<int, string> Msg = new Dictionary<int, string>
        {
            ...
            [9069] = "Press <D> to confirm download",
            [9070] = "Press <Esc> to exit",
            [9071] = "Press <H> to show help",
            [9072] = "Press <U> to get the latest version",
            [9073] = "Ready",
            [9074] = "",
            [9075] = "",
            [9076] = "Resolutions",
            ...
            [9084] = "Waiting",
            [9085] = "YouTube not responding",

            [9100] = "[class Validator]",
            [9110] = "Check for duplicate arguments on command line input",
            [9111] = "Command line input contains unknown argument(s)",
...
Download:
https://github.com/rytsikau/ee.Yrewind/releases/download/20220606/ee.yrewind_22.061.zip

Changelog:
https://github.com/rytsikau/ee.Yrewind/blob/main/CHANGELOG.md

If something doesn't work, please report:
https://github.com/rytsikau/ee.Yrewind/issues

Try previous versions:
https://github.com/rytsikau/ee.Yrewind/releases
...
";
        ...
        public const int BuildDate = 220606;
        public static readonly string Version = Assembly
            .GetExecutingAssembly().GetName().Version.ToString();

        // Random substring for temp files naming
        public static readonly string RandomString = Guid
            .NewGuid().ToString().Replace("-", "").Replace("+", "").Substring(0, 7);

        // Cache file fullname
        public static readonly string PathCache = Path.GetTempPath() + Constants.Name + "_cache.tmp";

        // URL of one-line file with info about latest release with content like
        ...
        public const int RealTimeBufferSeconds = 60;
        ...
        public const int CacheShelflifeMinutes = 60;
