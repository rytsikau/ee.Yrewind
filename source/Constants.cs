...
namespace yrewind
{
    ...
    static class Constants
    {
        ...
        public static readonly Dictionary<int, string> Msg = new Dictionary<int, string>
        {
            ...
            [9127] = "Check '-browser' argument",
            [9128] = "Command line input contains unknown argument(s)",
            ...
            [9229] = "Cannot get live stream information with browser",
            [9238] = "Video not found",
            [9239] = "It is not a live stream",
            [9240] = "Cannot get live stream information with browser",
            [9241] = "Cannot get live stream information",
            [9242] = "Cannot get live stream information with browser",
            [9243] = "Cannot get live stream information",
            [9244] = "Cannot get live stream information",
...
";
        ...
        public const int BuildDate = 220414; // YYMMDD
        ...
        // Format:
        // [_]YYMMDD;directUri (optional '_' blocks older versions)
        // Example:
        ...
        public const int CookieFileLengthMax = 1000000;
        public const int NetworkAttemptsNumber = 6;
        public const int NetworkAttemptDelayMilliseconds = 10000;
