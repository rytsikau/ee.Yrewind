...
namespace yrewind
{
    ...
    static class Constants
    {
        ...
        public static readonly Dictionary<int, string> Msg = new Dictionary<int, string>
        {
            ...
            [9084] = "Waiting",
            [9085] = "YouTube is not responding",
...
Download:
https://github.com/rytsikau/ee.Yrewind/releases/download/20220519/ee.yrewind_22.051.zip
...
";
        ...
        public const int BuildDate = 220519;
        ...
        public const string LogWord = "test200611";
