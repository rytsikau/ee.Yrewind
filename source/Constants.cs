...
namespace yrewind
{
    ...
    static class Constants
    {
        ...
        public static readonly Dictionary<int, string> Msg = new Dictionary<int, string>
        {
            ...
            [9413] = "Output file not completed, will trying again...",
...
";
        ...
        public const int BuildDate = 220622;
        ...
        public static readonly string PathCache =
            Path.GetTempPath() + Constants.Name.ToLower() + ".cache";
        ...
        public const int CommandLineLengthMax = 8191;
