...
namespace yrewind
{
    ...
    class CLInput
    {
        ...
        public static string CookieString { get; private set; } // cookie data
        ...
        int Parse_browser(string argValue)
        {
            ...
            {
                return 9127; // "Check '-browser' argument"
            }
        }
        #endregion
        ...
        int Parse_log(string argValue)
        {
            ...
            {
                return 9128; // "Command line input contains unknown argument(s)"
            }
