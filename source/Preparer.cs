...
namespace yrewind
{
    ...
    class Preparer
    {
        ...
        #region GetDirectUris - Determine [UriAdirect] and [UriVdirect]
        int GetDirectUris()
        {
            ...
            try
            {
                var items = IDInfo.JsonHtml.XPathSelectElements
            ...
            {
                // It seems direct URIs are taken from browser' netlog
                GetDirectUris_UseBrowser();
                return 0;
            }

            // Sometimes declared UriVdirect is just a link to another URL,
